// ActionScript file
	...
	private var setCoverFlag:Boolean = false;
 	...
 	private function itemDoubleClickHandler(event:ListEvent):void{
			...
			labVideoName.text = vi.videoName;
			...
			labTimeCount.text =vi.timeCount;
			labFileSize.text = vi.fileSize.toString()+"MB";
			labFileFormat.text = vi.fileFormat;
			labVideoDesc.text = vi.descn;
			labCreateTime.text = this.getCrateTimeFormatDate(vi.createTime);

...
// 	videoAlbumShips.addItem(videoAlbumShip);
 	...
 	videoInfoService.addVideoInfo(info,getCheckedVideoTypes(),getCheckedVideoAlbums(),keyWords);
 ...
 * */
 private function onSelect(event:Event):void
 {
 	...
 	else if(uploadFile.size> 1024*1024*1024*20){
 		Alert.show("文件太大,请上传20G以内的文件","提示信息");
 		this.initApp();
